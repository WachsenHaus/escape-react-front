...
const 마녀의꿈 = 22;
const 장미의비밀 = 23;
const 트레저헌터1우든펍의비밀 = 24;
const 트레져헌터2빅토리아호의침몰 = 25;
const 트레저헌터3거미의둥지 = 26;
const 트레저헌터4골든아이 = 27;

export const allThema = [
  0,
  1,
  2,
  3,
...
export const daejeonThema = [장기밀매, 신데렐라, 집착, 마션, 타이타닉, 카타콤]; //완료
export const jeonjuThema = [
  딜리버,
  좀비스쿨,
  피고인,
  헨젤과그레텔,
...
export const incheonThema = [타이타닉, 신데렐라, 장기밀매, TOWERING, 집착]; //완료
export const cheonhoThema = [
  더큐브,
  메이지,
  장기밀매파트2,
  사라진천사들,
...
export const jamsilThema = [로미오포인트, 신데렐라, 집착, 마션, 타이타닉, 카타콤]; //완료
